...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	// My buttons to add user interaction.
	gui_1->addGroup("Bone Rotation");
	static auto rotateX1 = gui_1->addVariable("Rotate X1:", m_bone_animation->yellowLimb.x);
	static auto rotateY1 = gui_1->addVariable("Rotate Y1:", m_bone_animation->yellowLimb.y);
	static auto rotateZ1 = gui_1->addVariable("Rotate Z1:", m_bone_animation->yellowLimb.z);
	static auto rotateX2 = gui_1->addVariable("Rotate X2:", m_bone_animation->pinkLimb.x);
	static auto rotateY2 = gui_1->addVariable("Rotate Y2:", m_bone_animation->pinkLimb.y);
	static auto rotateZ2 = gui_1->addVariable("Rotate Z2:", m_bone_animation->pinkLimb.z);
	static auto rotateX3 = gui_1->addVariable("Rotate X3:", m_bone_animation->blueLimb.x);
	static auto rotateY3 = gui_1->addVariable("Rotate Y3:", m_bone_animation->blueLimb.y);
	static auto rotateZ3 = gui_1->addVariable("Rotate Z3:", m_bone_animation->blueLimb.z);

	static auto invKine = gui_1->addVariable("Bone Move:", m_bone_animation->activateInvKine);
	static auto gX = gui_1->addVariable("Target X:", m_bone_animation->g.x);
	static auto gY = gui_1->addVariable("Target Y:", m_bone_animation->g.y);
	static auto gZ = gui_1->addVariable("Target Z:", m_bone_animation->g.z);
	static auto eX = gui_1->addVariable("Current End Position X:", m_bone_animation->e.x);
	static auto eY = gui_1->addVariable("Current End Position Y:", m_bone_animation->e.y);
	static auto eZ = gui_1->addVariable("current End Position Z:", m_bone_animation->e.z);
	...
	gui_1->addButton("Reset Bone Rotation", []()
	{
		...
		// Set the field values to 0 again.
		rotateX1->setValue(0);
		rotateY1->setValue(0);
		rotateZ1->setValue(30);
		rotateX2->setValue(0);
		rotateY2->setValue(0);
		rotateZ2->setValue(30);
		rotateX3->setValue(0);
		rotateY3->setValue(0);
		rotateZ3->setValue(30);
		invKine->setChecked(false);
		gX->setValue(3.0f);
		gY->setValue(8.0f);
		gZ->setValue(3.0f);
		eX->setValue(-4.6f);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	// Draw bone 1 to the screen.
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(m_bone_animation->bone1));
	bone_obj->obj_color = m_bone_animation->colors[1];
	draw_object(shader, *bone_obj);

	// Draw bone 2 onto the screen.
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(m_bone_animation->bone2));
	bone_obj->obj_color = m_bone_animation->colors[2];
	draw_object(shader, *bone_obj);

	// Draw bone 3 onto the screen.
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(m_bone_animation->bone3));
	bone_obj->obj_color = m_bone_animation->colors[3];
	draw_object(shader, *bone_obj);


	// Update the guide bones position.
	glm::mat4 guideObject = glm::mat4(1.0f);
	guideObject = glm::translate(guideObject, m_bone_animation->g);
	guideObject = glm::scale(guideObject, m_bone_animation->scale_vector[0]);

	// Draw the guide bone onto the screen.
	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(guideObject));
